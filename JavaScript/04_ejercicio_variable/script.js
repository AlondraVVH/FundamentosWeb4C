...
function declararVariables() {
    ...
    let fecha_nac = 2008; // Año de nacimiento
    ...
    let division = num1 / 10;
    alert("La suma es (1+2+5): " + suma);   
    alert("La resta es (1-5): " + resta);
    alert("La multiplicación es (2*3): " + multiplicacion);
    alert("La división es (1/10): " + division);
